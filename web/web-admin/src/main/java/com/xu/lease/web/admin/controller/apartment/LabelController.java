...
import com.xu.lease.model.entity.LabelInfo;
import com.xu.lease.model.enums.ItemType;
import com.xu.lease.web.admin.service.LabelInfoService;
...
//        动态条件查询
    ...
    public Result deleteLabelById(@RequestParam Long id) {
        ...
        boolean i = labelInfoService.removeById(id);
        return Result.ok();
    }
}
